...
__decorate([
    (0, inversify_express_utils_1.httpPost)("/", tokens_1.MIDDLEWARE_TOKENS.AuthMiddleware, (0, validation_middleware_1.validationPipe)(create_customer_dto_1.CreateCustomerDto)),
...
__decorate([
    (0, inversify_express_utils_1.httpPut)("/:id", tokens_1.MIDDLEWARE_TOKENS.AuthMiddleware, (0, validation_middleware_1.validationPipe)(id_dto_1.IdDto, "params"), (0, validation_middleware_1.validationPipe)(update_customer_dto_1.UpdateCustomerDto)),
    __param(0, (0, inversify_express_utils_1.request)()),
    __param(1, (0, inversify_express_utils_1.requestParam)()),
    __param(2, (0, inversify_express_utils_1.requestBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Request, id_dto_1.IdDto, update_customer_dto_1.UpdateCustomerDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", [Request, id_dto_1.IdDto]),
    __metadata("design:returntype", Promise)
], CustomerController.prototype, "deleteOneCustomer", null);
exports.CustomerController = CustomerController = __decorate([
    (0, inversify_express_utils_1.controller)("/api/customers"),
    __param(0, (0, inversify_1.inject)(tokens_1.SERVICE_TOKENS.CustomerService)),
